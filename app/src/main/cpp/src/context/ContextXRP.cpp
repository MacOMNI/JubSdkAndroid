...
JUB_RV ContextXRP::GetMainHDNode(const JUB_BYTE format, std::string& xpub) {
...
JUB_RV ContextXRP::GetAddress(const BIP32_Path& path, const JUB_UINT16 tag, std::string& address) {
...
JUB_RV ContextXRP::SetMyAddress(const BIP32_Path& path, std::string& address) {
...
JUB_RV ContextXRP::GetHDNode(const JUB_BYTE& format, const BIP32_Path& path, std::string& pubkey) {
...
JUB_RV ContextXRP::SignTransaction(const BIP32_Path& path,
                                   const JUB_TX_XRP& tx,
